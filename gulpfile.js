...
gulp.task("lint", function () {
  return gulp
    .src(["demo/scripts/directives.js", SRC_FILES, TEST_FILES])
    .pipe(
      eslint({
...
gulp.task(
  ...
  gulp.series("build", "server", function () {
    ...
    gulp.src(KARMA_FILES).pipe(karma(karmaConfig("watch")));
  })
);
...
gulp.task("foo", () => {
  return (
    gulp
      .src(["asset/src/js/foo/*.js", "asset/src/js/bar/*.js"])
